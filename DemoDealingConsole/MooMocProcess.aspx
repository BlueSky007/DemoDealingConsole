<%@ Page language="c#" Inherits="iExchange.DealingConsole.MooMocProcess" Codebehind="MooMocProcess.aspx.cs" %>
...
<HTML>
	<HEAD>
		...
		<SCRIPT event="BeforeRowColChange(oldRow, oldCol, newRow, newCol, cancel)" for="vsflexMooMoc">
			OnMooMocBeforeRowColChange(oldRow, oldCol, newRow, newCol, cancel);
		</SCRIPT>
		<SCRIPT event="ValidateEdit(row, col, cancel)" for="vsflexMooMoc">
			OnMooMocValidateEdit(row, col, cancel);			
		</SCRIPT>
	</HEAD>
	<BODY id="oBodyMooMoc" onload="MooMocInit()" onunload="MooMocFinish()" onkeydown="FilterKey(event)">
		<TABLE id="Table1" height="346" cellSpacing="2" cellPadding="2" width="698" align="center"
			...
			<TR>
				<TD vAlign="baseline" noWrap align="right" width="100%" colSpan="5">
					<OBJECT id="vsflexMooMoc" codeBase="./Cab/vsflex7.CAB#Version=7,0,1,160" width="98.56%"
						classid="clsid:C0A63B86-4B21-11d3-BD95-D426EF2C7949" vAlign="baseline">
				...
				<TD vAlign="baseline" noWrap align="right" width="100%"><FONT face="system"></FONT></TD>
			</TR>
		</TABLE>
	</BODY>
</HTML>
