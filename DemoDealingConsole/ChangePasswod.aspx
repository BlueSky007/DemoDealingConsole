...
<HTML>
	<HEAD>
		<title><%=GetLanguage("ChangePasswodTitle")%></title>
				...
				<table border="0" width="78%" height="131">
					<tr>
						<td width="100%" bgcolor="#d5d5d5" height="16">
							<p align="center"><b><font color="#000033" size="4"><%=GetLanguage("ChangePasswod")%></font></b></p>
						</td>
					</tr>
					<tr>
						<td width="100%" height="103"><div align="center">
								<center>
									<table  border="1" width="100%" bordercolorlight="#242424" bordercolordark="#FFFFFF"  cellspacing="0">
										<tr>
											<td width="32%" height="20" bgcolor="#f7f7f7"><%=GetLanguage("OldPassword")%></td>
										...
										<tr>
											<td width="32%" height="16"><%=GetLanguage("NewPassword")%></td>
											<td width="68%" height="16">
												<asp:TextBox id="txtNewPassword" class="input" runat="server" MaxLength="16" TextMode="Password"></asp:TextBox>
											</td>
										</tr>
										<tr>
											<td width="32%" height="20" bgcolor="#f7f7f7"><nobr><%=GetLanguage("ConfirmPassword")%></td>
											<td width="68%" height="20" bgcolor="#f7f7f7">
										...
										<tr>
											<td  height="16" colspan=2>
												<font color=red>*</font><%=GetLanguage("PasswodMsg")%>											
											</td>
										</tr>
										<tr>
