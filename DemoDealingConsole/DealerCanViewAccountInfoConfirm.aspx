...
<HTML>
	...
	<BODY id="oBodyConfirm" onload="OnConfirmLoad()">		
		<TABLE id="Table1" height="128" cellSpacing="4" cellPadding="2" border="0" bgColor="buttonface" style="width: 352px">
		    <TR>
				<TD id="TD26" vAlign="center" align="right">BL:</TD>
			...
			<TR id="trDQMaxMovePrice">
			    <TD id="TD23" vAlign="center" align="right">Execute Price:</TD>
			...
			<TR id="trLot">
			    <TD id="TD32" vAlign="center" align="right">Lot:</TD>
			...
			<TR>
				<TD align="center" rowSpan="2" colspan="2">
					<INPUT id="Button1" type="submit" value="  OK  " name="Button1" onclick="Submit();">&nbsp;&nbsp;
