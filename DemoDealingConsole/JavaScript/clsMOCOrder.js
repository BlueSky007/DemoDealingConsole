...
function MOCOrder(OrderID) {
    ...
    this.IsWithinAcceptTimeSpan = function () {
        ...
        var endTime = instrument.currentTradeTime.endTime;
    ...
    this.IsWithinCancelTimeSpan = function () {
        ...
        var instrument = this.GetInstrument();
        var endTime = instrument.currentTradeTime.endTime;
        return (this.tran.submitTime >= instrument.currentTradeTime.beginTime &&
        this.tran.submitTime <= endTime.setSeconds( endTime.getSeconds() - this.mainWindow.MooMocCancelDuration * 60 ));
        */
        //Modified by Michael on 2006-04-21--Begin
