...
<body onload="AccountStatusQueryOnLoad();" onunload="AccountStatusQueryOnUnload();"
    ...
    <table border="0" cellsapcing="0" cellpadding="0" width="100%" align="center">
        <tr>
            ...
            <td style="width: 140px; height: 28px" valign="middle" align="left">
            ...
            <td><input type="text" id="_AccountCodeText" name="_AccountCodeText" size="22" 
               onkeydown="AccountCodeText_OnKeyDown();" onchange="AccountCodeText_OnChange()" style="width:120px;background-color: #FFFFFF;" /></td>
